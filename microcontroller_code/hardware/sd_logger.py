...
class SDLogger:
    def __init__(self, i2c, led, internal_rtc, should_print: bool = True, print_in_csv_format = False, temp_unit: str = "C"):
        self.clock = Clock(i2c, internal_rtc)
    ...
    def start_new_log(self):
        ...
        dt_sanitised = self.clock.internal_now.replace(":", "-").replace(" ", "_")
    ...
    def log_data(self, co2_value: int|str|None, temp_value: float|str|None, humidity_value: float|str|None,
        ...
        with open(self.file_path, "a") as f:
            f.write(f"{self.clock.internal_now},{temp},{humidity_value},{co2_value},{voc_raw},{voc_index},{nox_raw},{nox_index},{pm10},{pm25},{pm100}\n")
    ...
    def print_sensor_data(self, temp_c, humidity, dew_point_c, co2, voc_raw, voc_index, nox_raw, nox_index, pm10, pm25, pm100):
        ...
        if self.print_in_csv_format:
            print(f"$AQS,{self.clock.internal_now},{temp},{humidity},{dp},{co2},{voc_raw},{voc_index},{nox_raw},{nox_index},{pm100},{pm25},{pm10}")
    ...
    def print_with_timestamp(self, msg: str):
        ...
        if self.should_print:
            print(f"RTC {self.clock.internal_now} | {msg}")
